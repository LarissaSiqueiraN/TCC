...
{
    public partial class adequacaobanco : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cpf = table.Column<string>(type: "nvarchar(55)", maxLength: 55, nullable: false),
                    Rg = table.Column<string>(type: "nvarchar(55)", maxLength: 55, nullable: true),
                    DataNascimento = table.Column<DateTime>(type: "datetime2", maxLength: 55, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nome = table.Column<string>(type: "nvarchar(55)", maxLength: 55, nullable: false),
                    Valor = table.Column<double>(type: "float", maxLength: 55, nullable: false),
                    ...
                    DataVenda = table.Column<DateTime>(type: "datetime2", maxLength: 55, nullable: true),
                    Ativo = table.Column<bool>(type: "bit", nullable: false),
                    ModificadoPor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UltimaModificacao = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
